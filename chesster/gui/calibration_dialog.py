...
from chesster.gui.calibration_dialog_detector import calibration_detector
import logging
...
class Calibration(QDialog):
    def __init__(self, parent=None):
        ...
        self.detector_elements = [self.checkBox_detector_show_debug]
    ...
    def toggle_detector(self, hide=False):
        for element in self.detector_elements:
            element.setHidden(hide)
    ...
    def start_calibration(self):
        if self.checkBox_vbc.isChecked():
            ...
            CaliDetector = calibration_detector(self.checkBox_detector_show_debug.isChecked(), parent=self.parent)
            CaliDetector.show()
        self.close()